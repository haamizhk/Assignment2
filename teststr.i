...
# 481 "teststr.c"
...

   {
      ...
      pcResult1 = Str_search(acHaystack, acNeedle);
      pcResult2 = strstr(acHaystack, acNeedle);
      assure(pcResult1 == pcResult2, 512);
   }
...
# 516 "teststr.c"
...

   {
      ...
      pcResult1 = Str_search(acHaystack, acNeedle);
      pcResult2 = strstr(acHaystack, acNeedle);
      assure(pcResult1 == pcResult2, 675);
   }
...
# 679 "teststr.c"
...

   {
      ...
      for (i = 0; i < STRESS_TEST_COUNT; i++)
      {
         ...
         assure(pcResult1 == pcResult2, 691);
      }
   }

   {
      ...
      for (i = 0; i < STRESS_TEST_COUNT; i++)
      {
         ...
         pcResult1 = Str_search(acSrc1, acSrc2);
         pcResult2 = strstr(acSrc1, acSrc2);
         assure(pcResult1 == pcResult2, 705);
      }
   }

   {
      ...
      for (i = 0; i < STRESS_TEST_COUNT; i++)
      {
         ...
         pcResult1 = Str_search(acSrc1, acSrc2);
         pcResult2 = strstr(acSrc1, acSrc2);
         assure(pcResult1 == pcResult2, 719);
      }
   }

   {
      ...
      for (i = 0; i < STRESS_TEST_COUNT; i++)
      {
         ...
         pcResult1 = Str_search(acSrc1, acSrc2);
         pcResult2 = strstr(acSrc1, acSrc2);
         assure(pcResult1 == pcResult2, 733);
      }
   }

   {
      ...
      for (i = 0; i < STRESS_TEST_COUNT; i++)
      {
         ...
         pcResult1 = Str_search(acSrc1, acSrc2);
         pcResult2 = strstr(acSrc1, acSrc2);
         assure(pcResult1 == pcResult2, 747);
      }
   }
}
