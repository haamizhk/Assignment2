...
# 27 "replace.c"
  "pcLine != NULL"
# 27 "replace.c" 3 4
  , "replace.c", 27, __extension__ __PRETTY_FUNCTION__))
# 27 "replace.c"
                        ;
...
# 28 "replace.c"
  "pcFrom != NULL"
# 28 "replace.c" 3 4
  , "replace.c", 28, __extension__ __PRETTY_FUNCTION__))
# 28 "replace.c"
                        ;
...
# 29 "replace.c"
  "pcTo != NULL"
# 29 "replace.c" 3 4
  , "replace.c", 29, __extension__ __PRETTY_FUNCTION__))
# 29 "replace.c"
                      ;
   pcTrace = pcLine;
...
# 83 "replace.c"
   ...
   while (fgets(acLine, MAX_LINE_SIZE, 
# 89 "replace.c" 3 4
                                      stdin
# 89 "replace.c"
                                           ) != 
